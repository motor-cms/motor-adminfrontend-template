...
- Updated dependencies [90d160d]
  - @motor-cms/ui-core@4.12.5
...
- 90d160d: - fix(form): Label-Spalte horizontaler Formularfelder auf feste Breite
- Updated dependencies [90d160d]
  - @motor-cms/ui-core@4.12.5-rc.1

## 4.12.5-rc.0

### Patch Changes

- - fix(form): Label-Spalte horizontaler Formularfelder auf feste Breite
- Updated dependencies
  - @motor-cms/ui-core@4.12.5-rc.0
...
- d7bd75b: fix(media): "copy URL" in the gallery and grid now copies the file's storage/CDN URL from the API (public S3/CloudFront on prod) instead of the backend /download route, which is only reachable behind the VPN and useless as a shared link (EN customer report)
...
- f383cec: fix(media): the lightbox (enlarged image) now receives the public storage/CDN URL as well, so its copy-link button no longer shares the VPN-only backend /download route — completes the copy-url fix for the gallery and grid
- Updated dependencies [b59b41b]
- Updated dependencies [9d7edf4]
- Updated dependencies [36cb07b]
  - @motor-cms/ui-core@4.12.4
...
- - fix(shortcuts): open overlay only with Option key to avoid macOS screenshot conflict (EN-2204)
- Updated dependencies
  - @motor-cms/ui-core@4.12.3-rc.0
...
- Updated dependencies [da200e2]
- Updated dependencies [58286e4]
- Updated dependencies [06eb5fd]
  - @motor-cms/ui-core@4.12.1
