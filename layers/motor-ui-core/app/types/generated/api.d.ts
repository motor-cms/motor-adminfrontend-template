export interface paths {
  ...
  '/builder-pages/{builderPage}/preview': {
    ...
    /**
         * Refresh a preview
         * @description Updates the cached page definition and fires a PreviewUpdated event.
         */
    put: operations['builderPagePreview.update']
    /**
         * Create a preview
  ...
  '/category-trees/{category_tree}/categories/{category}': {
    parameters: {
      query?: never
      header?: never
      path?: never
...
export interface components {
  schemas: {
    ...
    /** BuilderPagePreviewResource */
    BuilderPagePreviewResource: unknown[]
    /** BuilderPageResource */
    BuilderPageResource: {
      id: number
      name: string
    ...
    CustomContentTypeResource: {
      ...
      is_sortable: boolean
      integrations: Record<string, never> | string
...
export interface operations {
  ...
  'builderPagePreview.update': {
    ...
    responses: {
      /** @description `BuilderPagePreviewResource` */
      200: {
        headers: {
          [name: string]: unknown
        }
        content: {
          'application/json': {
            data: components['schemas']['BuilderPagePreviewResource']
            meta: {
              /** @constant */
              api_version: 'v2'
            }
